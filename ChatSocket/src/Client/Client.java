...
public class Client extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("Danh sÃ¡ch online", jPanel1);
        ...
        jLabel1.setText("Chá»�n ngÆ°á»�i nhÃ¢n");

        jLabel2.setText("Nháº­p tin nháº¯n");

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("{NgÆ°á»�i nháº­n}");
        ...
        jTabbedPane1.addTab("Nháº¯n tin", jPanel2);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(messageContent.isEmpty()){
            JOptionPane.showMessageDialog(rootPane, "Báº¡n chÆ°a nháº­p tin nháº¯n");
            return;
        }
        if(jComboBox1.getSelectedIndex()==0){
            try {
                write("send-to-global"+","+messageContent+","+this.id);
                jTextArea1.setText(jTextArea1.getText()+"Báº¡n: "+messageContent+"\n");
                jTextArea1.setCaretPosition(jTextArea1.getDocument().getLength());
            } catch (IOException ex) {
                JOptionPane.showMessageDialog(rootPane, "CÃ³ lá»—i xáº£y ra");
            }
        }else{
            try {
                String[] parner = ((String)jComboBox1.getSelectedItem()).split(" ");
                write("send-to-person"+","+messageContent+","+this.id+","+parner[1]);
                jTextArea1.setText(jTextArea1.getText()+"Báº¡n (tá»›i Client "+parner[1]+"): "+messageContent+"\n");
                jTextArea1.setCaretPosition(jTextArea1.getDocument().getLength());
            } catch (IOException ex) {
                JOptionPane.showMessageDialog(rootPane, "CÃ³ lá»—i xáº£y ra");
            }
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        if(jComboBox1.getSelectedIndex()==0){
            ...
            jLabel3.setText("Ä�ang nháº¯n vá»›i "+jComboBox1.getSelectedItem());
        }
        ...
        try {
            thread = new Thread() {
                ...
                public void run() {
                    ...
                    try {
                        // Gá»­i yÃªu cáº§u káº¿t ná»‘i tá»›i Server Ä‘ang láº¯ng nghe
                        // trÃªn mÃ¡y 'localhost' cá»•ng 7777.
                        socketOfClient = new Socket("192.168.1.5", 7777);
                        System.out.println("Káº¿t ná»‘i thÃ nh cÃ´ng!");
                        // Táº¡o luá»“ng Ä‘áº§u ra táº¡i client (Gá»­i dá»¯ liá»‡u tá»›i server)
                        os = new BufferedWriter(new OutputStreamWriter(socketOfClient.getOutputStream()));
                        // Luá»“ng Ä‘áº§u vÃ o táº¡i Client (Nháº­n dá»¯ liá»‡u tá»« server).
                        ...
                        while (true) {
                            ...
                            if (messageSplit[0].equals("update-online-list")) {
                                ...
                                for(int i=0; i<onlineSplit.length; i++){
                                    ...
                                    online+="Client "+onlineSplit[i]+" Ä‘ang online\n";
                                }
...
//                    socketOfClient.close();
    ...
    private void updateCombobox(){
        ...
        jComboBox1.addItem("Gá»­i táº¥t cáº£");
